...
#define KOL_LED       59         // Сколько светодиодов в гирлянде при первом включении
...
#define IR_MAX_LEDS   59         // Максимальное количество светодиодов при работе с пультом должно быть больше
// или равно KOL_LED
