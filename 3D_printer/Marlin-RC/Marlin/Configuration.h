...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker --> it was default
 // #define  DEFAULT_Kp 22.2
 // #define  DEFAULT_Ki 1.08
 // #define  DEFAULT_Kd 114

  #define  DEFAULT_Kp 15.79
  #define  DEFAULT_Ki 1.02
  #define  DEFAULT_Kd 60.92
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(200*16)/(2.0*20), (200*16)/(2.0*20), 200*16/0.8, 25000/30} //500*50 = 25000 shagov na 50 mm. u meny proshodit 30 mm
//#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 25}    // (mm/sec)
#define DEFAULT_MAX_FEEDRATE          {200, 200, 3, 20}    // (mm/sec)
